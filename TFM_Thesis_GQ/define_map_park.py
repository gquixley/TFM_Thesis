...
#def demand(rho): return (48*rho)*(rho <= 30) + 2700*(rho > 30)
#def supply(rho): return 2700*(rho <= 30) + (15*(30-rho)+2700)*(rho > 30)
...
junction_info[2] = {'in': [21], 'out': [11, 36], 'tdm': np.array([[0.4, 0.6]])}
junction_info[3] = {'in': [12, 36], 'out': [22], 'tdm': np.array([[1], [1]])}
junction_info[4] = {'in': [22], 'out': [20, 37], 'tdm': np.array([[0.6, 0.4]])}
...
junction_info[12] = {'in': [26], 'out': [12, 41], 'tdm': np.array([[0.6, 0.4]])}

junction_info[13] = {'in': [13, 44], 'out': [27], 'tdm': np.array([[1], [1]])}
junction_info[14] = {'in': [27], 'out': [4, 42], 'tdm': np.array([[0.4, 0.6]])}
...
junction_info[18] = {'in': [29], 'out': [14, 44], 'tdm': np.array([[0.6, 0.4]])}
...
junction_info[22] = {'in': [31], 'out': [17, 46], 'tdm': np.array([[0.6, 0.4]])}
junction_info[23] = {'in': [46, 18], 'out': [32], 'tdm': np.array([[1], [1]])}
junction_info[24] = {'in': [32], 'out': [16, 47], 'tdm': np.array([[0.5, 0.5]])}

junction_info[25] = {'in': [17, 50], 'out': [33], 'tdm': np.array([[1], [1]])}
junction_info[26] = {'in': [33], 'out': [8, 48], 'tdm': np.array([[0.7, 0.3]])}
...
junction_info[30] = {'in': [35], 'out': [50, 18], 'tdm': np.array([[0.7, 0.3]])}