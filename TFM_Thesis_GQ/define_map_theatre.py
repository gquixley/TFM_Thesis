...
network[1]['demand'] = demand
network[1]['supply'] = supply
def demand_upstream(t): return 0.1  # Marlow hill road
network[1]['source'] = demand_upstream
...
def demand_upstream(t): return 0.1  # Road from hospital/university
...
def demand_upstream(t): return 0.1  # Road from Shopping center
...
def demand_upstream(t): return 0.1  # Road from RGS
...
def demand_upstream(t): return 0.1  # Road from park
...
def demand_upstream(t): return 0.2  # Exit road from Theatre
...
junction_info[2] = {'in': [21], 'out': [11, 36], 'tdm': np.array([[0.5, 0.5]])}
...
junction_info[6] = {'in': [23], 'out': [10, 38], 'tdm': np.array([[0.5, 0.5]])}

junction_info[7] = {'in': [11, 41], 'out': [24], 'tdm': np.array([[1], [1]])}
junction_info[8] = {'in': [24], 'out': [2, 39], 'tdm': np.array([[0.5, 0.5]])}
junction_info[9] = {'in': [3, 39], 'out': [25], 'tdm': np.array([[1], [1]])}
junction_info[10] = {'in': [25], 'out': [13, 40], 'tdm': np.array([[0.5, 0.5]])}
...
junction_info[14] = {'in': [27], 'out': [4, 42], 'tdm': np.array([[0.6, 0.4]])}
...
junction_info[18] = {'in': [29], 'out': [14, 44], 'tdm': np.array([[0.5, 0.5]])}
...
junction_info[24] = {'in': [32], 'out': [16, 47], 'tdm': np.array([[0.7, 0.3]])}

junction_info[25] = {'in': [17, 50], 'out': [33], 'tdm': np.array([[1], [1]])}
junction_info[26] = {'in': [33], 'out': [8, 48], 'tdm': np.array([[0.5, 0.5]])}
junction_info[27] = {'in': [9, 48], 'out': [34], 'tdm': np.array([[1], [1]])}
junction_info[28] = {'in': [34], 'out': [19, 49], 'tdm': np.array([[0.7, 0.3]])}
junction_info[29] = {'in': [49, 20], 'out': [35], 'tdm': np.array([[1], [1]])}
junction_info[30] = {'in': [35], 'out': [50, 18], 'tdm': np.array([[0.5, 0.5]])}