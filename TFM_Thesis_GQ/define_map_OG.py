...
junction_info[6] = {'in': [23], 'out': [10, 38], 'tdm': np.array([[0.6, 0.4]])}

junction_info[7] = {'in': [11, 41], 'out': [24], 'tdm': np.array([[1], [1]])}
junction_info[8] = {'in': [24], 'out': [2, 39], 'tdm': np.array([[0.3, 0.7]])}
...
junction_info[20] = {'in': [30], 'out': [6, 45], 'tdm': np.array([[0.7, 0.3]])}
...
junction_info[24] = {'in': [32], 'out': [16, 47], 'tdm': np.array([[0.4, 0.6]])}
...
junction_info[28] = {'in': [34], 'out': [19, 49], 'tdm': np.array([[0.4, 0.6]])}
